...
const PrivacyPage = () => {
  return (
    <React.Fragment>
      <Navbar />
      <div className="mx-auto mb-32 mt-10 flex max-w-3xl flex-col justify-center space-y-8 text-neutral-400">
        <h1 className="mt-20 mb-4 text-5xl font-bold text-white">
        ...
        <h2 className="text-lg font-medium text-neutral-100">Interpretation</h2>
        <p className="leading-8">
        ...
        <h2 className="text-lg font-medium text-neutral-100">Definitions</h2>
        <p className="leading-8">For the purposes of this Privacy Policy:</p>
        <ul className="mx-12 list-disc space-y-6 marker:text-2xl marker:text-white">
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Account</strong> means a
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Company</strong> (referred to
              as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
              or &quot;Our&quot; in this Agreement) refers to trace.
            </p>
          </li>
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Cookies</strong> are small
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Country</strong> refers to:
              Morocco
            </p>
          </li>
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Device</strong> means any
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Personal Data</strong> is any
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Service</strong> refers to
              the Website.
            </p>
          </li>
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Service Provider </strong>
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Usage Data</strong> refers to
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">Website</strong> refers to
              trace, accessible from{' '}
              <a
                href="https://traceapp.vercel.app/"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://traceapp.vercel.app/
              </a>
            </p>
          </li>
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">You</strong> means the
        ...
        <h3 className="font-medium text-neutral-200">Personal Data</h3>
        <p className="leading-8">
        ...
        <ul className="mx-12 list-disc space-y-6 marker:text-2xl marker:text-white">
          <li>
            <p className="leading-8">Email address</p>
          </li>
          <li>
            <p className="leading-8">First name and last name</p>
          </li>
          <li>
            <p className="leading-8">Usage Data</p>
          </li>
        </ul>
        <h3 className="font-medium text-neutral-200">Usage Data</h3>
        <p className="leading-8">
        ...
        <ul className="mx-12 list-disc space-y-6 marker:text-2xl marker:text-white">
          ...
          <li className="leading-8">
            <strong className="text-neutral-200">Flash Cookies.</strong> Certain
          ...
          <li className="leading-8">
            <strong className="text-neutral-200">Web Beacons.</strong> Certain
        ...
        <ul className="mx-12 list-disc space-y-6 marker:text-2xl marker:text-white">
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">To contact You:</strong> To
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">To provide You</strong> with
          ...
          <li>
            <p className="leading-8">
              <strong className="text-neutral-200">For other purposes</strong>:
        ...
        <ul className="mx-12 list-disc space-y-6 marker:text-2xl marker:text-white">
          ...
          <li className="leading-8">
            <strong className="text-neutral-200">With Affiliates:</strong> We
          ...
          <li className="leading-8">
            <strong className="text-neutral-200">With other users:</strong> when
          ...
          <li className="leading-8">
            <strong className="text-neutral-200">With Your consent</strong>: We
        ...
        <h3 className="font-medium text-neutral-200">Business Transactions</h3>
        <p className="leading-8">
        ...
        <h3 className="font-medium text-neutral-200">Law enforcement</h3>
        <p className="leading-8">
        ...
        <h1 className="text-xl font-semibold text-neutral-50">Contact Us</h1>
        <p className="leading-8">
          If you have any questions about this Privacy Policy, You can contact
          us:
        </p>
        <ul className="mx-12 list-disc space-y-6 marker:text-2xl marker:text-white">
          <li>By email: support@trace.com</li>
        </ul>
      </div>
      <Footer />
    </React.Fragment>
