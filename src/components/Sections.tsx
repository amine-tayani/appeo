    ...
    <React.Fragment>
      <section className="body-font relative text-gray-600">
        <div className="container mx-auto flex flex-wrap items-center px-5 py-24 sm:flex-nowrap">
          ...
          <div className="relative mt-8 flex h-96 w-full items-center justify-center overflow-hidden rounded-xl bg-blue-400 bg-gradient-to-r from-[#0052D4] via-[#4364F7] to-[#6FB1FC] sm:left-20 sm:mr-10 sm:w-3/4 md:left-40 md:w-[900px] lg:left-40 lg:mt-0 lg:h-[600px] lg:w-3/5 lg:p-20">
            <div className="flex flex-wrap ">
              <div className="">
                <img
                  className=" relative max-w-[300px] rounded-2xl sm:left-20 sm:max-w-[400px] lg:left-16 lg:max-w-3xl"
      ...
      <section className="body-font relative text-gray-600">
        <div className="container mx-auto flex flex-wrap items-center px-5 py-24 sm:flex-nowrap">
          <div className="relative order-last flex h-96 w-full justify-center overflow-hidden  rounded-xl bg-blue-400 bg-gradient-to-r from-[#0052D4] via-[#4364F7] to-[#6FB1FC] p-20 sm:left-20 sm:mr-10 sm:w-3/4 md:right-40 md:mr-32 md:w-[900px] lg:right-40 lg:order-first lg:mr-40 lg:h-[600px] lg:w-3/5">
            <div className="flex flex-wrap ">
              <div className="">
                <img
                  className="relative max-w-[300px] rounded-2xl sm:left-20 sm:max-w-[400px] lg:right-12 lg:max-w-3xl"
