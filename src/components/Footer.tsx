  ...
  return (
    <footer>
      <div className="container mx-auto flex flex-col flex-wrap px-5 py-24  md:flex-row md:flex-nowrap md:items-center lg:items-start">
        <div className="mx-auto w-1/3 flex-shrink-0 text-center md:mx-0 md:text-left ">
        ...
        <div className=" mt-10 flex flex-grow flex-wrap text-center md:mt-0 md:text-left">
          <div className="w-full px-4 md:w-1/2 lg:w-1/5">
            <h2 className=" mb-10 text-lg font-semibold text-white">Product</h2>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/5">
            <h2 className=" mb-10 text-lg font-semibold text-white">Company</h2>
            <nav className=" list-none space-y-4">
              <li>
                <a className="cursor-pointer text-sm text-neutral-400 hover:text-neutral-200">
                  About Us
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/5">
            <h2 className=" mb-10 text-lg font-semibold text-white">
              Resources
            </h2>
            <nav className=" list-none space-y-4">
              <li>
